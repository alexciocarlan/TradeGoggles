...
export interface DailyPrepData {
  ...
  gkUncertaintyAccepted: boolean; gkStopLossExecution: boolean; gkNoAddingToLoss: boolean; gkRiskCalmness: boolean; gkDailyRiskAmount: number;
...
export interface WeeklyNewsEvent {
  event: string;
  time: string;
  tier: number; 
}
