...
export type IntentFamily = 'CONFIDENCE' | 'FILL' | 'ROTATION' | 'UNDEFINED';
...
export interface DailyPrepData {
  ...
  duringSession2?: string; in30MinSession2?: string;
...
export type WeekOpenType = 'Gap Up' | 'Gap Down' | 'Open Outside Value' | 'Open Inside Value' | 'None';
...
export interface WeeklyPrepData {
  ...
  // Matrix Context Fields
  weeklyOTF?: WeeklyOTF;
  weekOpenType?: WeekOpenType;
  weeklyStructureAnomaly?: WeeklyStructureAnomaly;
