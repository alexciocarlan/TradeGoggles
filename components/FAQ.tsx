    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="bg-blue-600/5 border border-blue-500/20 p-10 rounded-[3rem] flex items-center justify-between group overflow-hidden relative">
         <div className="relative z-10">
            <h4 className="text-white font-black uppercase tracking-widest text-base mb-2">Nu ai găsit răspunsul?</h4>
            <p className="text-slate-400 text-sm font-medium">Consultă secțiunea Trade Academy pentru ghiduri detaliate.</p>
         </div>
         <button className="bg-blue-600 hover:bg-blue-500 text-white font-black px-8 py-4 rounded-2xl uppercase text-[10px] tracking-widest transition-all shadow-xl shadow-blue-600/20 active:scale-95 relative z-10">
            Mergi la Academy
         </button>
