...
const TradeDetail: React.FC = () => {
  ...
  return (
    <div className={`max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-700 pb-20 px-6 ${isDeleting ? 'opacity-30 pointer-events-none' : ''}`}>
      
      {/* TOP NAVIGATION & ACTIONS */}
      <div className="flex items-center justify-between no-print">
        <button onClick={() => navigate('/trades')} className="bg-[#0b1222] border border-slate-800 px-6 py-2.5 rounded-xl text-slate-400 hover:text-white flex items-center text-[10px] font-black uppercase tracking-widest shadow-xl transition-all">
