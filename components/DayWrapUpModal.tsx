             ...
             <div className="space-y-8">
                <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button onClick={() => setFormData({...formData, pmrTradedPlan: 'NU'})} className={`flex-1 py-3 rounded-xl font-black text-xs transition-all border ${formData.pmrTradedPlan === 'NU' ? 'bg-red-600 text-white border-red-500 shadow-lg shadow-red-600/20' : 'bg-slate-900 text-slate-500 border-slate-800'}`}>NU</button>
                    </div>
                </div>
                <div>
