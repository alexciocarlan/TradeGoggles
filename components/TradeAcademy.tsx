...
const TradeAcademy: React.FC<TradeAcademyProps> = ({ language }) => {
            ...
            {filteredCourses.map(course => (
              <div key={course.id} className="bg-[#0b1222] border border-slate-800 rounded-[2.5rem] overflow-hidden group hover:border-blue-500/50 transition-all shadow-xl flex flex-col">
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <h4 className="text-xl font-black text-white uppercase tracking-tight mb-6 leading-tight group-hover:text-blue-400 transition-colors">
                    {course.title}
                  </h4>
